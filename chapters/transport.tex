...
{\bf The deep-LPM region}: another useful approximation considers the limit $\tau_f$ is so large that many collisions contribute coherently to the branching. 
...
\begin{eqnarray}
- \frac{1}{4} \nabla^2_{\vec{k}}\vec{F} + \frac{i}{\tau_f(k)\hat{q}_3}\vec{F} = \frac{2\vec{k}}{\hat{q}_3}.
\end{eqnarray}
