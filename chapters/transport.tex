...
It is surprising that an analytic solution exists for a simplified version of the transport equation \cite{Blaizot:2013hx,Blaizot:2015jea}, which captures essential features of transport equation in the deep-LPM region.
...
\end{itemize}
In this way, the authors of \cite{Blaizot:2013hx} simply the transport equation into, 
\begin{eqnarray}
