...
We present the comparison between the simulation and the theory in terms of the path-length dependent differential branching rate at different temperatures and different $x$ values for a 100 $GeV$ heavy quark using $\alpha_s=0.3$ (figure \ref{mass.png}).
